...
public:
    ...
    typedef void ( *EventListener )( int eventCode, int eventDevice, int eventParam );
    ...
    boolean queueEvent( int eventCode, int eventDevice, int eventParam, EventPriority pri = kLowPriority );
...
private:
    ...
    public:
        ...
        // an interrupt.
        boolean queueEvent( int eventCode, int eventDevice, int eventParam );
        ...
        boolean popEvent( int* eventCode, int* eventDevice, int* eventParam );
    ...
    private:
        ...
        struct EventElement
        {
            ...
            int device;	// each event has a single integer parameter
    ...
    public:
        ...
        int sendEvent( int eventCode, int eventDevice, int param );
...
inline boolean EventManager::queueEvent( int eventCode, int eventDevice, int eventParam, EventPriority pri )
{
    return ( pri == kHighPriority ) ?
        mHighPriorityQueue.queueEvent( eventCode, eventDevice, eventParam ) : mLowPriorityQueue.queueEvent( eventCode, eventDevice, eventParam );
}
